    ...
    <div id="glowny">
        <?php
            if(isset($_POST['przedmiot'])){
                ...
                if($wirt==0){
                    $zapytanie10="SELECT concat(nazwisko_ucznia, ' ', imie_ucznia) as uczen, id_ucznia, nr_dziennik  FROM uczniowie where id_klasy=$id_klasy order by nr_dziennik asc;";
                }else{
                    $zapytanie10="SELECT concat(nazwisko_ucznia, ' ', imie_ucznia) as uczen, id_ucznia  FROM wirtualne_klasy where id_klasy=$id_klasy order by nazwisko_ucznia asc, imie_ucznia asc;";
            ...
            $wyslij10=mysqli_query($polaczenie,$zapytanie10);
                ...
                echo"<table>";
                echo "<tr><th rowspan='2'>lp.</th><th rowspan='2'>uczeń</th><th colspan='4'>Okres 1</th><th colspan='7'>Okres 2</th></tr>";
