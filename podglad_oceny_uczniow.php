            ...
            if(isset($_POST['uczen'])){
                ...
                while($row=mysqli_fetch_array($wyslij)){
                    ...
                    while($row1=mysqli_fetch_array($wyslij1)){
                        if($row1['ocena']==1.5){
                            echo "<span class='ocena' style='background-color:".$row1['kolor'].";'><a title='Kategoria: ".$row1['nazwa_kategorii']."&#10;Data: ".$row1['data']."&#10;Nauczyciel: ".$row1['dodal']." &#10;Waga: ".$row1['waga']."&#10;Dodał: ".$row1['dodal']."&#10;&#10;Komentarz: ".$row1['komentarz']."' >1+ </a></span>";
                            ...
                            echo "<span class='ocena' style='background-color:".$row1['kolor'].";'><a title='Ocena: nieklasyfikowany&#10;Kategoria: ".$row1['nazwa_kategorii']."&#10;Data: ".$row1['data']."&#10;Nauczyciel: ".$row1['dodal']." &#10;Licz do średniej: nie&#10;Dodał: ".$row1['dodal']."&#10;&#10;Komentarz: ".$row1['komentarz']."' >nk </a></span>";
                        }else if ($row1['ocena']==0.02){
                            echo "<span class='ocena' style='background-color:".$row1['kolor'].";'><a title='Ocena: zwolniony&#10;Kategoria: ".$row1['nazwa_kategorii']."&#10;Data: ".$row1['data']."&#10;Nauczyciel: ".$row1['dodal']." &#10;Licz do średniej: nie&#10;Dodał: ".$row1['dodal']."&#10;&#10;Komentarz: ".$row1['komentarz']."' >zw </a></span>";
                            ...
                            echo "<span class='ocena' style='background-color:".$row1['kolor'].";'><a title='Ocena: nieprzygotowany&#10;Kategoria: ".$row1['nazwa_kategorii']."&#10;Data: ".$row1['data']."&#10;Nauczyciel: ".$row1['dodal']." &#10;Licz do średniej: nie&#10;Dodał: ".$row1['dodal']."&#10;&#10;Komentarz: ".$row1['komentarz']."' >np </a></span>";
                        }else if ($row1['ocena']==0.04){
                            echo "<span class='ocena' style='background-color:".$row1['kolor'].";'><a title='Ocena: nieuczęszczał&#10;Kategoria: ".$row1['nazwa_kategorii']."&#10;Data: ".$row1['data']."&#10;Nauczyciel: ".$row1['dodal']." &#10;Licz do średniej: nie&#10;Dodał: ".$row1['dodal']."&#10;&#10;Komentarz: ".$row1['komentarz']."' >nu </a></span>";
                        }else{
                ...
                echo "</td>";
                echo "<td>";
                $zapytanie2="SELECT round(avg(ocena),2) as srednia from oceny inner join uczniowie on oceny.id_ucznia=uczniowie.id_ucznia inner join przedmioty on 
                oceny.id_przedmiotu=przedmioty.id_przedmiotu inner join kategorie_ocen on oceny.id_kategorii=kategorie_ocen.id_kategorii where oceny.id_ucznia=$id_ucznia 
                and oceny.semestr=1 and oceny.id_kategorii=5 and oceny.ocena between 1 and 6 ;";
                        $wyslij2=mysqli_query($polaczenie,$zapytanie2);  
                        while($row2=mysqli_fetch_array($wyslij2)){
                            if($row2[0]==''){
                                echo "-";
                ...
                echo "<td>";
                $zapytanie2="SELECT round(avg(ocena),2) as srednia from oceny inner join uczniowie on oceny.id_ucznia=uczniowie.id_ucznia inner join przedmioty on 
                oceny.id_przedmiotu=przedmioty.id_przedmiotu inner join kategorie_ocen on oceny.id_kategorii=kategorie_ocen.id_kategorii where oceny.id_ucznia=$id_ucznia and 
                oceny.semestr=1 and oceny.id_kategorii=8 and oceny.ocena between 1 and 6 ;";
                        $wyslij2=mysqli_query($polaczenie,$zapytanie2);  
                        while($row2=mysqli_fetch_array($wyslij2)){
                            if($row2[0]==''){
                                echo "-";
                ...
                echo "</td>";
                echo "<td>";
                $zapytanie2="SELECT round(avg(ocena),2) as srednia from oceny inner join uczniowie on oceny.id_ucznia=uczniowie.id_ucznia inner join przedmioty on oceny.id_przedmiotu=przedmioty.id_przedmiotu inner join kategorie_ocen on oceny.id_kategorii=kategorie_ocen.id_kategorii where oceny.id_ucznia=$id_ucznia and oceny.semestr=2 and oceny.id_kategorii=5 and oceny.ocena between 1 and 6 ;";
                        $wyslij2=mysqli_query($polaczenie,$zapytanie2);  
                        while($row2=mysqli_fetch_array($wyslij2)){
                            if($row2[0]==''){
                                echo "-";
                ...
                echo "</td>";
                echo "<td>";
                $zapytanie2="SELECT round(avg(ocena),2) as srednia from oceny inner join uczniowie on oceny.id_ucznia=uczniowie.id_ucznia inner join przedmioty on oceny.id_przedmiotu=przedmioty.id_przedmiotu inner join kategorie_ocen on oceny.id_kategorii=kategorie_ocen.id_kategorii where oceny.id_ucznia=$id_ucznia and oceny.semestr=2 and oceny.id_kategorii=8 and oceny.ocena between 1 and 6 ;";
                        $wyslij2=mysqli_query($polaczenie,$zapytanie2);  
                        while($row2=mysqli_fetch_array($wyslij2)){
                            if($row2[0]==''){
                                echo "-";
                ...
                echo "</td>";
                echo "<td>";
                $zapytanie2="SELECT round(avg(ocena),2) as srednia from oceny inner join uczniowie on oceny.id_ucznia=uczniowie.id_ucznia inner join przedmioty on oceny.id_przedmiotu=przedmioty.id_przedmiotu inner join kategorie_ocen on oceny.id_kategorii=kategorie_ocen.id_kategorii where oceny.id_ucznia=$id_ucznia  and oceny.id_kategorii=6 and oceny.ocena between 1 and 6 ;";
                        $wyslij2=mysqli_query($polaczenie,$zapytanie2);  
                        while($row2=mysqli_fetch_array($wyslij2)){
                            if($row2[0]==''){
                                echo "-";
                ...
                echo "</td>";
                echo "<td id='ocenka'>";
                $zapytanie2="SELECT round(avg(ocena),2) as srednia from oceny inner join uczniowie on oceny.id_ucznia=uczniowie.id_ucznia inner join przedmioty on oceny.id_przedmiotu=przedmioty.id_przedmiotu inner join kategorie_ocen on oceny.id_kategorii=kategorie_ocen.id_kategorii where oceny.id_ucznia=$id_ucznia  and oceny.id_kategorii=7 and oceny.ocena between 1 and 6 ;";
                        $wyslij2=mysqli_query($polaczenie,$zapytanie2);  
                        while($row2=mysqli_fetch_array($wyslij2)){
                            if($row2[0]==''){
                                echo "-";
