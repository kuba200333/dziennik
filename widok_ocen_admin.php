    ...
    <div id="glowny">
        <?php
            if(isset($_POST['przedmiot'])){
                ...
                if($wirt==0){
                    $zapytanie10="SELECT concat(nazwisko_ucznia, ' ', imie_ucznia) as uczen, id_ucznia, uczniowie.nr_dziennik as nr FROM uczniowie where id_klasy=$id_klasy order by uczniowie.nr_dziennik asc;";
                }else{
            ...
            $wyslij10=mysqli_query($polaczenie,$zapytanie10);
                ...
                $x=1;
            while($row10=mysqli_fetch_array($wyslij10)){
                echo "<tr><td>".$row10['nr'].".</td><td style='text-align: left;'>".$row10['uczen']."</td>";
