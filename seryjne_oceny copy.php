...
<div id="kontener">
    ...
    <?php
        ...
        echo "<table>
        <tr><th>lp.</th><th>Uczeń</th><th>Oceny</th><th>Śr. sem</th><th>Średnia R.</th><th>Dodaj ocenę</th><th>Komentarz</th></tr>";
        require "connect.php";
        ...
        while($row=mysqli_fetch_array($wyslij)){
            echo '<tr id="'.$row['id_ucznia'].'"><td>'.$x++.'.</td><td style="text-align:left;">'.$row['duczen']."</td>
            <td id='ocenka'>";
            $zapytanie1="SELECT oceny.id_oceny as id_oceny, oceny.ocena as ocena, kategorie_ocen.skrót_kategorii as kategoria, kategorie_ocen.nazwa_kategorii as nazwa_kategorii, concat(nauczyciele.nazwisko, ' ', nauczyciele.imie) as dodal, oceny.komentarz as komentarz, oceny.data as data, nauczyciele.login, oceny.waga as waga, kategorie_ocen.kolor as kolor, nie_licz from oceny 
                ...
                inner join nauczyciele on oceny.id_nauczyciela=nauczyciele.id_nauczyciela where concat(uczniowie.nazwisko_ucznia, ' ', uczniowie.imie_ucznia)= '$row[2]' and przedmioty.id_przedmiotu='$id_przedmiot' and semestr=$semestr order by data asc;";
            ...
            echo "</td><td>
            <input list='oceny' id='ocena' class='ocena' name='ocena[".$row['id_ucznia']."]'>
