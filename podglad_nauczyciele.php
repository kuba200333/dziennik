    ...
    <a href="\dziennik_lekcyjny\dziennik.php">Powrót do strony głównej <br></a>
        ...
        <?php
            ...
            while($row=mysqli_fetch_array($result)){
                ...
                if($_SESSION['admin'] ==1){
                    echo"<td class='usuwanie'><form action='' method='post'><input type='hidden' name='id_nauczyciela' value='".$row["id_nauczyciela"]."'><input type='submit' name='usun' value='X'></form></td>";
                }
                echo"</tr>";
            }
